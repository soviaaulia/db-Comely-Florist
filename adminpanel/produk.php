<?php
    ...
    $query = mysqli_query($con, "SELECT a. *, b.nama AS nama_kategori FROM produk a JOIN kategori b ON 
    a.kategori_id=b.id");
    $jumlahProduk = mysqli_num_rows ($query);

    $queryKateogri = mysqli_query($con, "SELECT * FROM kategori");
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <select name="kategori" id="kategori" class="form-control" required>
                       ...
                       <?php
                            while($data=mysqli_fetch_array($queryKateogri)){
                       ?>
            ...
            <?php
                if(isset($_POST['simpan'])){
                    ...
                    $random_name = generatedRandomString(20);
